...
parser = argparse.ArgumentParser(
    prog="python -m shared_schema", description=DESC
)
...
exporter = subparsers.add_parser(
    name="export", help="Print the schema in various formats"
)
...
submission_scheme_exporter = subparsers.add_parser(
    name="sub-scm", help="Export submission scheme data"
)
submission_scheme_exporter.add_argument(
    "dest", help="The path to save scheme description files at"
)
submission_scheme_exporter.add_argument(
...
regimens_exporter = subparsers.add_parser(
    name="regimens", help="Export treatment regimens"
)
...
refseq_exporter = subparsers.add_parser(
    name="refseqs", help="Print reference sequence metadata as CSV"
)
